<section>
	<article>
		<h1>Sudoku</h1>
		<div>
			<table style='margin: auto;'> <!-- Conteneur du sudoku -->
				<?php include("sudoku.php"); ?>
			</table>
		</div>
	</article>
	<article>
