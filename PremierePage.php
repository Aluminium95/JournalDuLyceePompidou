<section role='PremierePage'> <!-- Toutes les pages sont définies par des sections -->
	...
	<!-- Bannière info tirage ( css dans head_foot.css ) -->
		<ul id='infoTirage'>
			<li>27 mars 2011</li> <!-- Date -->
			<li>Alpha 4.0.5</li> <!-- Version ?-->
			<li>Site web / flux atom</li> <!-- liens -->
		</ul>
	<!-- Article Principal -->
	...
	<article role='Edito'> <!-- Court éditorial en première page --> 
		...
		Aenean eu lectus nec sapien <em>feugiat accumsan</em>. <!-- Mise en italique --> 
		Curabitur imperdiet nisl nec 
